...
function PrivacyBody() {
  return (
    <>
      ...
      <p>
        QRForge does not require sign-up and does not use accounts. It sets no
      ...
      <ul>
        <li>The data you choose to work with.</li>
      ...
      <p>
        ...
        disk by QRForge itself beyond what you explicitly save.
      </p>

      <h3>Analytics</h3>
      <p>
        QRForge includes no third-party analytics and no advertising trackers.
        ...
        data or their contents.
      </p>

      <h3>Children’s privacy</h3>
      <p>
        QRForge is a general-purpose utility and does not knowingly collect
      ...
      <h3>Contact</h3>
      <p>
        QRForge is open source. For questions about this policy, email{" "}
        <a
...
function TermsBody() {
  return (
    <>
      <p>
        By using QRForge, you agree to these terms. They’re short on purpose.
      </p>
      ...
      <p>
        You are responsible for the data you use with the tool. Because the
      ...
      <ul>
        <li>Don’t use QRForge for anything you don’t have the right to do.</li>
      ...
      <p>QRForge is built on open-source libraries, including qrcode. Each is governed by its own license.</p>

      <h3>Changes</h3>
      <p>
        These terms may be updated from time to time. Continued use of
        QRForge after a change constitutes acceptance of the updated terms.
      </p>
    </>
  );
}
